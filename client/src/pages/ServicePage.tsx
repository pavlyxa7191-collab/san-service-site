...
const SERVICES: Record<string, ServiceInfo> = {
  klopov: {
    ...
    methods: [
      { name: "Холодный туман", desc: "Мелкодисперсное распыление инсектицида. Проникает в щели, матрасы, мебель. Наиболее эффективный метод.", price: "от 2 000 ₽" },
    ...
    stages: [
      { num: "01", title: "Диагностика", desc: "Специалист осматривает помещение, определяет очаги заражения и степень поражения" },
      { num: "02", title: "Подготовка", desc: "Вы готовите квартиру по инструкции: убираете вещи, накрываете продукты" },
  ...
  gryzunov: {
    ...
    methods: [
      { name: "Раскладка приманок", desc: "Профессиональные родентициды в специальных станциях. Безопасно для людей и домашних животных.", price: "от 2 000 ₽" },
      { name: "Механические ловушки", desc: "Эффективны при небольшом заражении. Не требуют химических препаратов.", price: "от 2 000 ₽" },
      { name: "Комплексная дератизация", desc: "Сочетание методов + герметизация путей проникновения. Максимальная эффективность.", price: "от 5 000 ₽" },
    ],
    stages: [
