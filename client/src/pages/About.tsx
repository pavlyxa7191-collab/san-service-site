...
export default function About() {
  ...
  useEffect(() => {
    applyPageSeo({
      title: "О компании — Санитарная служба",
      description:
        "Профессиональная санитарная служба с 2008 года. Более 12 000 выполненных заказов, гарантия до 3 лет, лицензия СЭС, сертифицированные препараты.",
    });
  }, []);
