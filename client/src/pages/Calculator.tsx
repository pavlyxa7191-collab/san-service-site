      ...
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} className="flex items-center gap-2">
          <div
            ...
            style={{
              background: i < current ? "#CC0000" : i === current ? "#0d2b5e" : "#E0E0E0",
...
export default function CalculatorPage() {
      ...
      <div className="min-h-screen bg-white flex items-center justify-center py-20">
        <div className="container max-w-lg text-center">
          ...
          <h1
            ...
            style={{ fontSize: "2rem", color: "#0d2b5e", letterSpacing: "-0.025em" }}
          >
            Заявка принята!
          </h1>
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F5F5F5" }}>
      {/* Header */}
      <div style={{ background: "#0d2b5e", borderBottom: "2px solid #CC0000" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8" style={{ border: "1px solid #E0E0E0" }}>
              ...
              <h2 className="font-black text-xl mb-1" style={{ color: "#0d2b5e", letterSpacing: "-0.02em" }}>
                {steps[step].title}
              </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {propertyTypes.map((pt) => (
                    ...
                    >
                      ...
                      <span className="font-semibold text-sm" style={{ color: "#0d2b5e" }}>
                        {pt.label}
                      </span>
                    </button>
                  ))}
              ...
              {step === 1 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {areaOptions.map((ao) => (
                    ...
                    >
                      <div>
                        <div className="font-bold text-sm" style={{ color: "#0d2b5e" }}>
                          {ao.label}
                        </div>
                ...
                <div className="flex flex-col gap-3">
                  {treatmentMethods.map((tm) => (
                    ...
                    >
                      ...
                      {tm.priceAdd < 0 && (
                        <span className="text-xs font-bold" style={{ color: "#1a3a6b" }}>
                          {tm.priceAdd.toLocaleString()} ₽
                        </span>
                      )}
                    </button>
          ...
          <div className="flex flex-col gap-6">
            ...
            {step >= 3 && price.min > 0 && (
              <div className="bg-white p-6" style={{ border: "2px solid #CC0000" }}>
                ...
                <div className="flex items-center gap-2 text-xs" style={{ color: "#0d2b5e" }}>
