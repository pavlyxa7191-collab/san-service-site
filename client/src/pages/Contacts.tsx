    ...
    <div className="bg-white">
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact info */}
          <div>
            <div className="flex items-center gap-3 mb-8" style={{ borderBottom: "2px solid #0A0A0A", paddingBottom: "1rem" }}>
              <div className="red-square" />
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4 p-6" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <div>
                  ...
                  <a href="tel:+79300354841" className="font-black text-xl no-underline" style={{ color: "#0A0A0A" }}>
                    8(930)035-48-41
                  </a>
              ...
              <div className="flex items-start gap-4 p-6" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <div>
                  ...
                  <a href="mailto:info@ses88.ru" className="font-semibold no-underline" style={{ color: "#0A0A0A" }}>
                    info@ses88.ru
                  </a>
                </div>
              </div>
          ...
          <div>
            ...
            {submitted ? (
              <div className="p-12 text-center" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <h3 className="font-black text-xl mb-3" style={{ color: "#0A0A0A" }}>Заявка принята!</h3>
