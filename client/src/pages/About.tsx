    ...
    <div className="bg-white">
      ...
      <div className="container py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            <div className="flex items-center gap-3 mb-6" style={{ borderBottom: "2px solid #0d2b5e", paddingBottom: "1rem" }}>
              <div className="red-square" />
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={text} className="flex items-start gap-4 p-4" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                  ...
                  <span className="text-sm" style={{ color: "#0d2b5e" }}>{text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {licenses.map((lic) => (
              <div key={lic} className="flex items-start gap-3 p-4" style={{ border: "1px solid #E0E0E0" }}>
                ...
                <span className="text-sm" style={{ color: "#0d2b5e" }}>{lic}</span>
              </div>
            ))}
          </div>
        </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={key} style={{ borderBottom: "1px solid #E0E0E0" }}>
                      ...
                      <td className="py-2" style={{ color: "#0d2b5e" }}>{val}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
