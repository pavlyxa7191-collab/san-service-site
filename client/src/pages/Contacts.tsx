            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4 p-6" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <div>
                  ...
                  <a href="tel:+79300354841" className="font-black text-xl no-underline" style={{ color: "#000919" }}>
                    8(930)035-48-41
                  </a>
              ...
              <div className="flex items-start gap-4 p-6" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <div>
                  ...
                  <a href="mailto:info@ses88.ru" className="font-semibold no-underline" style={{ color: "#000919" }}>
                    info@ses88.ru
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <div>
                  ...
                  <div className="font-semibold text-sm" style={{ color: "#000919" }}>
          ...
          <div>
            ...
            {submitted ? (
              <div className="p-12 text-center" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
                ...
                <h3 className="font-black text-xl mb-3" style={{ color: "#000919" }}>Заявка принята!</h3>
