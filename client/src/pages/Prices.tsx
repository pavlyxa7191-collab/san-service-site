            ...
            <table className="w-full" style={{ borderCollapse: "collapse" }}>
              ...
              <tbody>
                {priceTable.map((row, i) => (
                  ...
                  >
                    <td className="p-4 font-semibold text-sm" style={{ color: "#0A0A0A" }}>
                      {row.service}
                    </td>
                    ...
                    <td className="p-4 text-center text-sm" style={{ color: "#0A0A0A" }}>
                      {row.house}
                    </td>
                    <td className="p-4 text-center text-sm" style={{ color: "#0A0A0A" }}>
                      {row.office}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px" style={{ background: "#E0E0E0" }}>
            {methods.map((m) => (
              <div key={m.name} className="bg-white p-8">
                ...
                <h3 className="font-bold text-base mb-3" style={{ color: "#0A0A0A" }}>{m.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={item} className="flex items-center gap-3">
                ...
                <span className="text-sm" style={{ color: "#0A0A0A" }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
